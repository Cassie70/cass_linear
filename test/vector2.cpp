...
TEST_CASE("Vector2 construction and conversions", "[Vector2]") {
  ...
  SECTION("Component constructor initializes correctly") {
    cass::Vector2<float> v(3.5f, -2.1f);
    REQUIRE(v.x == 3.5f);
    REQUIRE(v.y == -2.1f);
  }

  SECTION("Conversion constructor converts scalar types") {
    cass::Vector2<int> vInt(3, 4);
    cass::Vector2<double> vDouble(vInt);
...
TEST_CASE("Vector2 arithmetic operations", "[Vector2]") {
  SECTION("Addition of vectors") {
    cass::Vector2<int> a(1, 2);
    cass::Vector2<int> b(3, 4);
    auto res = a + b;
    REQUIRE(res.x == 4);
    REQUIRE(res.y == 6);
  }
  ...
  SECTION("Subtraction of vectors") {
    cass::Vector2<float> a(5.5f, 7.5f);
    cass::Vector2<float> b(2.0f, 3.0f);
    auto res = a - b;
    REQUIRE(res.x == 3.5f);
    REQUIRE(res.y == 4.5f);
  }
  ...
  SECTION("In-place addition and subtraction") {
    cass::Vector2<int> v(1, 2);
    v += cass::Vector2<int>(3, 4);
    REQUIRE(v.x == 4);
    REQUIRE(v.y == 6);

    v -= cass::Vector2<int>(1, 1);
    REQUIRE(v.x == 3);
    REQUIRE(v.y == 5);
  }
}
...
TEST_CASE("Vector2 geometry operations", "[Vector2]") {
  SECTION("Dot product") {
    cass::Vector2<double> a(1.0, 3.0);
    cass::Vector2<double> b(4.0, -2.0);
    REQUIRE(a.dot(b) == -2.0);
  }

  SECTION("Magnitude") {
    cass::Vector2<double> v(3.0, 4.0);
